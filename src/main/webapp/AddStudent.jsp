...
<h1 class="centered">Below Are the Students Enrolled For Courses </h1>
...
PreparedStatement prep = db.con.prepareStatement("select * from srequest");
...
out.println(" <h3> ID: "+r.getInt("id")+" - "+r.getString("name")+" Applied for Course "+cname+"</h3>");
out.println("</div>");
out.println("</div>");
}
  }catch(Exception e){
